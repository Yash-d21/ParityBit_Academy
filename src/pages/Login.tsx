    ...
    <div className="min-h-screen grid lg:grid-cols-2 overflow-hidden bg-[#FBFBF7]">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-[#1A122E] via-[#241B3D] to-[#1A122E] p-12 text-white overflow-hidden">
        ...
        <div className="relative z-20 flex items-end justify-center h-[500px]">
          ...
          <div className="relative" style={{ width: '550px', height: '400px' }}>
            ...
            >
              ...
              >
                <Pupil size={12} maxDistance={5} pupilColor="#1A122E" forceLookX={(password.length > 0 && showPassword) ? -5 : undefined} forceLookY={(password.length > 0 && showPassword) ? -4 : undefined} />
                <Pupil size={12} maxDistance={5} pupilColor="#1A122E" forceLookX={(password.length > 0 && showPassword) ? -5 : undefined} forceLookY={(password.length > 0 && showPassword) ? -4 : undefined} />
              </div>
              {/* Horizontal line for mouth */}
              <div 
                className="absolute w-20 h-[4px] bg-[#1A122E] rounded-full transition-all duration-200 ease-out"
                style={{
        ...
        <div className="relative z-20 flex items-center gap-8 text-[10px] uppercase font-black tracking-widest text-white/40">
          <Link to="/privacy" className="hover:text-[#C77DFF] transition-colors">
            Privacy Policy
          </Link>
          <Link to="/terms" className="hover:text-[#C77DFF] transition-colors">
            Terms of Service
          </Link>
          <Link to="/refund" className="hover:text-[#C77DFF] transition-colors">
            Refunds
          </Link>
        </div>
        ...
        <div className="absolute top-1/4 right-1/4 size-64 bg-[#7B2CBF]/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-1/4 left-1/4 size-96 bg-[#C77DFF]/10 rounded-full blur-3xl animate-pulse" />
      </div>
      ...
      <div className="flex items-center justify-center p-8 bg-[#FBFBF7]">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-black tracking-tighter text-[#1A122E] mb-2 uppercase">Welcome back!</h1>
            <p className="text-slate-500 text-sm font-medium">Please enter your student credentials</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <Checkbox id="remember" className="border-slate-300 data-[state=checked]:bg-[#7B2CBF] data-[state=checked]:border-[#7B2CBF]" />
                <Label
                  htmlFor="remember"
              ...
              <a
                href="#"
                className="text-xs text-[#7B2CBF] hover:underline font-bold"
              >
                Forgot password?
              </a>
            </div>
          ...
          <div className="text-center text-sm font-bold text-slate-500 mt-6">
            ...
            <Link to="/signup" className="text-[#1A122E] hover:text-[#7B2CBF] transition-colors underline decoration-[#C77DFF]/40 underline-offset-4">
              Join the Cohort
            </Link>
          </div>
        </div>
