        ...
        >
          ...
          <div className="prose prose-slate prose-lg max-w-none text-slate-700 space-y-8 font-medium leading-relaxed">
            ...
            <section>
              ...
              <p>
                The CyberMasteryX Certification is awarded upon the successful completion of all training modules and the final capstone project. ParityBit Security reserves the right to withhold certification if academic integrity is compromised.
              </p>
            </section>
