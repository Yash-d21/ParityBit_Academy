...
const features = [
  ...
  },
  {
    icon: Award,
    tag: 'Certified',
    title: 'pCCSP - Certified Cyber Security Practitioner',
    description:
      'Earn the industry-recognized pCCSP - Certified Cyber Security Practitioner to validate your skills. This certificate will never expire.',
  },
];
