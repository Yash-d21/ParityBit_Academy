...
const testimonials = [
...

  {
    ...
    body: 'I was stuck in IT support for 3 years. This complete security bundle gave me the exact roadmap to transition into cybersecurity. The pCCSP certification genuinely moved my resume to the top.',
    rating: 5,
  },
  {
    name: 'Sneha Nair',
