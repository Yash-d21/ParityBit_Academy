...
>(({ className, align = "center", sideOffset = 4, showArrow = false, ...props }, ref) => (
  <PopoverPrimitive.Portal>
    ...
    >
      {props.children}
      {showArrow && (
        <PopoverPrimitive.Arrow className="-my-px fill-white drop-shadow-[0_1px_0_rgba(26,18,46,0.1)]" />
      )}
    </PopoverPrimitive.Content>
  </PopoverPrimitive.Portal>
));
